...
namespace Boxey.Core {
    ...
    public class NoiseSettings {
        ...
        [Range(0.01f, 2f)] public float amplitude = 10f;
    ...
    public class PlanetCreator : MonoBehaviour {
        ...
        private void Create() {
            ...
            VoxelNoise.SetNoises();
            //Create Needed Data
            var lod = planetLODS[0];
            lod.viewDistance -= planetRadius / 1.75f;
            var chunkData = new ChunkData(planetSettings, worldSizeInChunks * chunkSize, planetRadius, valueGate, createGate,
                doSmoothing, doFlatShading, lod, _planetMat);
