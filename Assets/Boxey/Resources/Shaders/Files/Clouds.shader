...
Shader "Clouds"
{
	Properties
	{
		...
		[ASEBegin]_CloudColor("Cloud Color", Color) = (1,1,1,0)
		_CloudSize1("Cloud Size", Float) = 1
		_CloudSoftness("Cloud Softness", Range( 0.01 , 1)) = 0.25
		_CloudCutoff("Cloud Cutoff", Range( 0 , 1)) = 0.5277489
		_CloudSpeed1("Cloud Speed", Float) = 0.15
		_SSSPower("SSS Power", Range( 0 , 5)) = 0.5
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 appendResult64 = (float4(mulTime59 , mulTime59 , lerpResult10_g1 , 0.0));
				float simplePerlin3D15 = snoise( ( float4( WorldPosition , 0.0 ) - appendResult64 ).xyz*_CloudSize1 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float lerpResult10_g1 = lerp( 0.0 , 1.0 , frac( ( sin( dotResult4_g1 ) * 43758.55 ) ));
				float4 appendResult64 = (float4(mulTime59 , mulTime59 , lerpResult10_g1 , 0.0));
				float simplePerlin3D15 = snoise( ( float4( ase_worldPos , 0.0 ) - appendResult64 ).xyz*_CloudSize1 );
				simplePerlin3D15 = simplePerlin3D15*0.5 + 0.5;
...
Node;AmplifyShaderEditor.SaturateNode;38;-942.3486,9.287246;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;35;-1076.349,12.28725;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
