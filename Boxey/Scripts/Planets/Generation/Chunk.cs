...
namespace Boxey.Scripts.Planets.Generation {
    public class Chunk {
        ...
        public Chunk(float[,,] map, Vector3Int position, Vector3 offset, int chunkSize, float valueGate, float createGate, bool doSmoothing, bool flatShading, int viewDistance, int colliderDistance, Material mat) {
